...
A declaração ``<!DOCTYPE>`` indica a :term:`DTD` à qual o XML encontra-se associado, ou seja, define as regras estruturais do :term:`documento`. O :term:`SciELO Publishing Schema` utiliza como base o padrão `JATS versão 1.0 <http://jats.nlm.nih.gov/publishing/1.0/>`_ e `1.1 <http://jats.nlm.nih.gov/publishing/1.1/>`_.
