...
Esta tag tem a mesma função da tag <supplementary-material>, mas é utilizada quando a menção do material suplementar esta em linha, ou seja descrita em um parágrafo.
...
..note:: Para consultar valores dos atributos @mimetype e @mime-subtype, consultar link:GUSTAVO
